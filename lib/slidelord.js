...
export class slidelord extends Component {
  ...
  render() {
    const { value, orientation, tooltip, reverse, labels, min, max, handleLabel } = this.props
...
const RangeFill = styled.div`
  display: block;
  background-color: ${theme.colors.turquoiseblue};
...
const RangeHandle = styled.div`
  background: ${theme.colors.turquoiseblue};
  border: 10px solid;
